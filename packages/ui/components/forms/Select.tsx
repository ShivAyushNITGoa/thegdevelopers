...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, options, label, helperText, error, fullWidth = false, id, placeholder, ...props }, ref) => {
    ...
    return (
      <div className={cn("mb-4", fullWidth ? "w-full" : "")}>
        ...
        <select
          ...
          ref={ref}
          className={cn(
            "block px-3 py-2 bg-white dark:bg-gray-800 border rounded-md text-sm shadow-sm",
